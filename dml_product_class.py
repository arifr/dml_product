...
log_model_name = "Class_{}_{}_{}_{}_{}".format(trunk.__class__.__name__, args.miner, train_dataset.__class__.__name__, num_epochs, args.embedding) 
...
acc_calc = AccuracyCalculator(exclude=('AMI',),k=100)
