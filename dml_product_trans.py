...
trunk = torch.load(args.model_fname)
trunk_output_size = trunk.last_channel
...
log_model_name = "Trans_{}_{}_{}_{}_{}".format(trunk.__class__.__name__, args.miner, train_dataset.__class__.__name__, num_epochs, args.embedding) 
...
acc_calc = AccuracyCalculator(exclude=('AMI','NMI','r_precision', 'mean_average_precision_at_r'),k=100)
...
end_of_epoch_hook = hooks.end_of_epoch_hook(tester,dataset_dict,model_folder, test_interval=100)
